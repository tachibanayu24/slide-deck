...
<s-slide layout="text">
  ...
  <ul class="space-y-3 text-lg">
    <li>
      <strong class="text-slate-800">ポイント</strong>
      <span class="text-slate-500">— 説明テキスト</span>
    </li>
  </ul>
</s-slide>
  ...
  <div data-area="text">
    ...
    <div class="space-y-3">
      <div class="flex items-start gap-3">
        <span
          class="inline-block px-2.5 py-0.5 bg-blue-100 text-blue-800 text-xs font-bold rounded-full"
          >ラベル</span
        >
        <div>
...
<s-slide layout="text">
  ...
  <p class="text-slate-500 mb-4">説明テキスト。</p>
  <div
    class="bg-slate-900 text-slate-200 p-5 rounded-lg text-sm font-mono leading-relaxed"
  >
    <div class="text-slate-500">// コメント</div>
    <div>
      &lt;<span class="text-blue-400">s-slide</span>
      <span class="text-amber-300">layout</span>=<span class="text-green-400"
        >"title"</span
      >&gt;
    </div>
    <div class="pl-4">
      &lt;<span class="text-blue-400">h1</span>&gt;Hello&lt;/<span
        class="text-blue-400"
        >h1</span
      >&gt;
    </div>
...
<s-slide layout="section">
  <p class="text-sm text-blue-600 font-semibold tracking-wider uppercase">
    Chapter 1
  </p>
...
<s-slide layout="text" header="キーメッセージ">
  ...
  <div class="bg-blue-50 border-l-4 border-blue-500 rounded-r-lg p-5 mb-4">
    <p class="text-blue-900 text-lg font-medium m-0">
      強調したいメッセージをここに。
    </p>
  </div>
...
<s-slide layout="chart" header="Data">
  ...
  <div>
    <s-chart
      type="bar"
      data='[{"label":"Q1","value":80},{"label":"Q2","value":95},{"label":"Q3","value":110},{"label":"Q4","value":120}]'
    ></s-chart>
  </div>
</s-slide>
```
...
<s-slide layout="text-image" header="Market">
  ...
  <div data-area="visual">
    <s-chart
      type="donut"
      label="シェア"
      data='[{"label":"A社","value":35},{"label":"当社","value":28},{"label":"C社","value":22},{"label":"その他","value":15}]'
    ></s-chart>
  </div>
</s-slide>
...
<s-slide layout="text-image" header="Tech">
  ...
  <div data-area="visual">
    <s-chart
      type="bar-horizontal"
      data='[{"label":"TypeScript","value":85},{"label":"Python","value":78},{"label":"Rust","value":42},{"label":"Go","value":38}]'
    ></s-chart>
  </div>
</s-slide>
```
...
<s-slide layout="chart" header="Growth">
  ...
  <div>
    <s-chart
      type="line"
      series='["売上","利益"]'
      data='[{"label":"2022","values":[100,40]},{"label":"2023","values":[150,60]},{"label":"2024","values":[210,95]},{"label":"2025","values":[280,130]}]'
    ></s-chart>
  </div>
</s-slide>
...
<s-slide layout="text-image" header="Analysis">
  <div data-area="text">
    ...
    <p class="text-slate-500">
      エネルギー密度 vs サイクル寿命で各技術をプロット
    </p>
  </div>
  <div data-area="visual">
    <s-chart
      type="scatter"
      x-label="エネルギー密度 (Wh/kg)"
      y-label="サイクル寿命"
      data='[{"label":"LFP","x":160,"y":3000,"group":"リチウム"},{"label":"NMC","x":250,"y":1500,"group":"リチウム"},{"label":"Na-ion","x":120,"y":2000,"group":"次世代"},{"label":"固体","x":400,"y":1000,"group":"次世代"}]'
    ></s-chart>
  </div>
</s-slide>
```
...
<s-slide layout="text" header="主要指標">
  ...
  <div class="grid grid-cols-3 gap-6">
    ...
    <div class="text-center">
      <div class="text-5xl font-black text-blue-600">
        3.2<span class="text-2xl">M</span>
      </div>
    ...
    <div class="text-center">
      <div class="text-5xl font-black text-blue-600">
        ¥1.2<span class="text-2xl">B</span>
      </div>
...
<s-slide layout="text" header="ロードマップ">
  ...
  <div class="space-y-4 border-l-2 border-blue-200 pl-6 ml-2">
    <div class="relative">
      <div
        class="absolute -left-[33px] top-1 w-4 h-4 bg-blue-600 rounded-full border-2 border-white"
      ></div>
    ...
    <div class="relative">
      <div
        class="absolute -left-[33px] top-1 w-4 h-4 bg-blue-300 rounded-full border-2 border-white"
      ></div>
    ...
    <div class="relative">
      <div
        class="absolute -left-[33px] top-1 w-4 h-4 bg-slate-200 rounded-full border-2 border-white"
      ></div>
...
>
  <p class="text-blue-400 text-sm font-bold tracking-widest mb-4">
    PRODUCT UPDATE 2026
  </p>
  <h1 class="text-5xl font-black text-white mb-6">メインタイトル</h1>
  <div class="flex gap-4 mt-4">
    <div
      class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg px-5 py-3 text-center"
    >
...
<s-slide layout="text" header="特徴">
  ...
  <div class="grid grid-cols-2 gap-4">
    ...
    <div class="bg-slate-50 rounded-xl p-5">
      <div
        class="w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center mb-3"
      >
    ...
    <div class="bg-slate-50 rounded-xl p-5">
      <div
        class="w-10 h-10 bg-amber-100 rounded-lg flex items-center justify-center mb-3"
      >
    ...
    <div class="bg-slate-50 rounded-xl p-5">
      <div
        class="w-10 h-10 bg-violet-100 rounded-lg flex items-center justify-center mb-3"
      >
